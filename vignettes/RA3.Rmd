...
```{r, eval=TRUE, fig.align='center', fig.height=4, fig.width=5}
set.seed(2020)
H_tsne <- Rtsne::Rtsne(t(result$H[1: (nrow(result$H)-5), ]))$Y # Here 5 refers to the dimension of the third component
...
```{r, eval=TRUE, fig.align='center', fig.height=4, fig.width=5}
set.seed(2020)
H2_tsne <- Rtsne::Rtsne(t(result2$H[1: (nrow(result2$H)-5), ]))$Y # Here 5 refers to the dimension of the third component
